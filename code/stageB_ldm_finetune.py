...
def generate_images(
    generative_model, fmri_latents_dataset_train, fmri_latents_dataset_test, config
):
...
def main(config):
    ...
    img_transform_test = transforms.Compose(
        [normalize, transforms.Resize((config.img_size, config.img_size)), channel_last]
    )
    ...
    generative_model = fLDM(
        ...
        activation_function_conditioning=config.activation_function_conditioning,
...
def get_args_parser():
    ...
    parser.add_argument(
        "--activation_function", type=str, choices=["relu", "silu"], default="silu"
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    print(config.loss_function, config.activation_function, config.activation_function_conditioning)
